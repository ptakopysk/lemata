...
for dist, count_deri, count_infl in results:
    ...
    if f_deri > best_f_deri:
        best_f_deri = f_deri
        best_dist_deri = (dist, p_deri, r_deri)
    ...
    if f_infl > best_f_infl:
        best_f_infl = f_infl
        best_dist_infl = (dist, p_infl, r_infl)

logging.info('Print result')
#print('For infl, best F1 = {} achieved with dist, prec, rec = {}'.format(best_f_infl, best_dist_infl))
print('For deri, best F1 = {} achieved with dist, prec, rec = {}'.format(best_f_deri, best_dist_deri))
